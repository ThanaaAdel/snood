...
class ArchiveProfessionalEmploymentModel {
  int? code;
  Data? data;
  String? msg;

  ArchiveProfessionalEmploymentModel({
    this.code,
    this.data,
    this.msg,
  });

  factory ArchiveProfessionalEmploymentModel.fromJson(Map<String, dynamic> json) => ArchiveProfessionalEmploymentModel(
    code: json["code"],
