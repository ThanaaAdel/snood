...
class InsertTransefareServiceModel {
  int? code;
  Data? data;
  String? msg;

  InsertTransefareServiceModel({
    this.code,
    this.data,
    this.msg,
  });

  factory InsertTransefareServiceModel.fromJson(Map<String, dynamic> json) => InsertTransefareServiceModel(
    code: json["code"],
