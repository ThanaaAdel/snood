...
class ReplaiesComplainModel {
  int? code;
  Data? data;
  String? msg;

  ReplaiesComplainModel({
    this.code,
    this.data,
    this.msg,
  });

  factory ReplaiesComplainModel.fromJson(Map<String, dynamic> json) => ReplaiesComplainModel(
    code: json["code"],
...
class ComplaintReply {
  ...
  factory ComplaintReply.fromJson(Map<String, dynamic> json) => ComplaintReply(
    ...
    dateOfReply: json["date_of_reply"],
