...
class MediationContractArchiveModel {
  int? code;
  Data? data;
  String? msg;

  MediationContractArchiveModel({
    this.code,
    this.data,
    this.msg,
  });

  factory MediationContractArchiveModel.fromJson(Map<String, dynamic> json) => MediationContractArchiveModel(
    code: json["code"],
